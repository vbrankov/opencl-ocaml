...
#	@ocamlc -o test.exe -custom -ccopt '-L$(OPENCLDIR)/lib/x86' -cclib -lOpenCL cl_impl.o $(SOURCES)
	@ocamlopt -o test.exe -ccopt '-L$(OPENCLDIR)/lib/x86' -cclib -lOpenCL cl_impl.o $(SOURCES)
