...
module Device_info = struct
  ...
  let max_compute_units                 : int t = 0x1002
  let max_work_item_dimensions          : int t = 0x1003
  let max_work_group_size               : int t = 0x1004
  ...
  let global_mem_cacheline_size         : int t = 0x101d
  let global_mem_cache_size             : int t = 0x101e
  let global_mem_size                   : int t = 0x101f
  let max_constant_buffer_size          : unit t = 0x1020
  let max_constant_args                 : unit t = 0x1021
  let local_mem_type                    : unit t = 0x1022
  let local_mem_size                    : int t = 0x1023
  ...
  let driver_version                    : unit t = 0x102d
  ...
  let opencl_c_version                  : string t = 0x103d
...
external create_buffer : Context.t -> Mem_flags.t list
  -> ('a, 'b) Buffer_contents.t -> ('a, 'b) Mem.t = "caml_create_buffer"
